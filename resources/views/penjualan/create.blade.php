    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('penjualans.store') }}" method="POST" enctype="multipart/form-data" id="quickForm">
                    @csrf
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="customer_id">
                                        @foreach ($customers as $cs)
                                            <option value="{{ $cs->id }}">{{ $cs->CompanyName }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jumlah" class="form-control" id="exampleInputPassword1"
                                        placeholder="jumlah Barang Yang Tersedia" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="harga" class="form-control" id="exampleInputPassword1"
                                        placeholder="harga Barang Yang Tersedia" required>
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="form-group">
