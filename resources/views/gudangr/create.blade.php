...
@section('content')
    <section class="content-header ml-3 mb-2 pt-5">
        <title>Create | Gudang Retur</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Penambahan Data Gudang Retur</h3>
                </div>

                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('gudangr.store') }}" method="POST" enctype="multipart/form-data" id="quickForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="retur_id">
